...
public class PlayerStatsMono : MonoBehaviour
{
    ...
    WeaponInstance _equippedWeapon;
    ...
    public void EquipWeapon(WeaponInstance wp)
    {
        _equippedWeapon = wp;
    ...
    public void RecalculateStats()
    {
        ...
        if (_equippedWeapon != null)
        {
            ...
            //def += b.addDef;
            //mdef += b.addMdef;
            //var stat = WeaponCalculator.GetFinalStat(_equippedWeapon);
            var stat = WeaponCalculator.GetBaseStatByLevel(_equippedWeapon);

            // apply enhance lên stat đã scale theo level
            float percent = 1f + _equippedWeapon.enhanceLevel * 0.1f;
            ...
            atk += stat.addAtk;
            smpt += stat.addSmpt;
            critChance += stat.addCritChance;
            critDamage += stat.addCritDamage;
            def += stat.addDef;
            mdef += stat.addMdef;
        }
       ...
       // critChance = Mathf.Clamp01(critChance * (1f + totalPercentCritChance));
        ...
        critDamage = Mathf.Max(0.5f, critDamage);
    ...
    public void AddMDefense(float value)
    {
        mdef += value;
    }
